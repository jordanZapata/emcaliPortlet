...
<h1 class="text-center">SUSPENSION TEMPORAL, CLAUSURA Y/O RETIRO</h1>
<hr />

<portlet:actionURL name='susTempClausuraRetiro'
	var='susTempClausuraRetiroURL' />


<aui:form method="post" name="${ susTempClausuraRetiro }"
	action="${ susTempClausuraRetiroURL }">
	<aui:row>
		<aui:col span="6">
		...
		<aui:col span="6">
			<aui:select name="tipoTramite" id="tipoTramite"
				...
				<aui:option selected="true" value="suspension_temporal">Suspension temporal</aui:option>
				<aui:option value="clusura">Clusura</aui:option>
				<aui:option value="retiro">Retiro</aui:option>
			</aui:select>
		</aui:col>
	</aui:row>
	<aui:row>
