...
<h1 class="text-center">VERIFICAR FACTURACION / RECLAMO POR ALTO
	CONSUMO</h1>
<hr />

<portlet:actionURL name='recAltoConsumo' var='recAltoConsumoURL' />
...
<aui:form method="post" name="${ recAltoConsumo }"
	action="${ recAltoConsumoURL }">
	<aui:row>
		<aui:col span="6">
		...
		<aui:col span="6">
			<aui:select name="tipoTramite" id="tipoTramite"
				...
				<aui:option selected="true" value="alto_consumo">RECLAMO POR ALTO CONSUMO</aui:option>
			</aui:select>
		</aui:col>
	</aui:row>
	<aui:row>
	...
	<aui:row>
		...
		<aui:col span="6">
			...
			<aui:input id="acueductoAlcantarillado" name="serviReclamo"
				...
				label="ACUEDUCTO / ALCANTARILLADO" />
		</aui:col>
	</aui:row>
	<aui:row>
		<aui:col span="6">
